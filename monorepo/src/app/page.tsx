...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* First Section - Hero/Home */}
      <section id="hero" className="min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-5xl mx-auto">
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-light leading-tight mb-8">
            The DeFi Data Infrastructure <br />
            for <span className="text-teal-300">Modern Applications</span>
          </h1>
      ...
      {/* Second Section with Code Editor - API */}
      <motion.section
        id="api"
      ...
      {/* Fourth Section - Pools/Dashboard */}
      <motion.section
        id="pools"
        className="min-h-screen flex items-center justify-center px-6"
        initial={{ opacity: 0, y: 80 }}
      ...
      >
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <a 
              href="https://ironjams-organization.gitbook.io/lixer-docs"
              target="_blank"
        ...
        <div className="bg-black/40 backdrop-blur-md rounded-2xl border border-white/10 px-4 py-3 shadow-2xl relative overflow-hidden">
          <div className="flex items-center space-x-6 relative z-10">
            <button 
              ...
              className={`w-12 h-12 bg-gray-900 rounded-xl flex items-center justify-center hover:scale-110 transition-all duration-200 ${activeWindow === null ? 'ring-1 ring-teal-400 shadow-[0_0_15px_rgba(20,184,166,0.7)]' : ''}`}
            >
            ...
            <button 
              ...
              className={`w-12 h-12 bg-gray-900 rounded-xl flex items-center justify-center hover:scale-110 transition-all duration-200 ${activeWindow === 'WebSocket' ? 'ring-1 ring-teal-400 shadow-[0_0_15px_rgba(20,184,166,0.7)]' : ''}`}
            >
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button 
              onClick={() => scrollToSection('api')}
              className={`w-12 h-12 bg-gray-900 rounded-xl flex items-center justify-center hover:scale-110 transition-all duration-200 ${activeWindow === 'Stats' ? 'ring-1 ring-teal-400 shadow-[0_0_15px_rgba(20,184,166,0.7)]' : ''}`}
            >
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button 
              ...
              className={`w-12 h-12 bg-gray-900 rounded-xl flex items-center justify-center hover:scale-110 transition-all duration-200 ${activeWindow === 'Pools' ? 'ring-1 ring-teal-400 shadow-[0_0_15px_rgba(20,184,166,0.7)]' : ''}`}
            >
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button 
              ...
              className={`w-12 h-12 bg-gray-900 rounded-xl flex items-center justify-center hover:scale-110 transition-all duration-200 ${activeWindow === 'infos' ? 'ring-1 ring-teal-400 shadow-[0_0_15px_rgba(20,184,166,0.7)]' : ''}`}
            >
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
